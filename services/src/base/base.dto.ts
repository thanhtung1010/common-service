...
export abstract class BaseDto {
    static fromJson<T extends BaseDto, V>(
        this: ClassType<T>,
        plain: V,
    ...
    static createEmpty<T extends BaseDto>(
        this: ClassType<T>,
        options?: ClassTransformOptions
    ): T {
    ...
    static clone<T extends BaseDto, V extends T>(
        this: ClassType<T>,
        plain: V,
        options?: ClassTransformOptions
    ): T {
    ...
    static merge<T extends BaseDto, V>(
        this: ClassType<T>,
        classObj: T,
        plain: V,
        options?: ClassTransformOptions
    ...
    static toJson<T extends BaseDto, V>(
        this: ClassType<T>,
        classObj: T
    ): Object {
        const plainObj = instanceToPlain(classObj);
     ...
     * get value in object: BaseDto.get('obj.key1')
     * get value in array: BaseDto.get('arr[index]')
     * get value in array object: BaseDto.get('arr[index].key1')
     */
    static get<T extends BaseDto>(
        this: ClassType<T>,
        data: T,
        path: string
    ): any {
